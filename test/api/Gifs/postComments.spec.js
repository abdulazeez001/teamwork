describe(`API :: POST /api/${version}/gifs/:gifId/comment`,function(){
    let token
    let gifId
    ...
    context('when comment is ok',function(){
        it('saves the comment, return 200 and comment information',function(done){
            ...
            request
            .post(`/api/${version}/gifs/${gifId}/comment`)
            ...
            .end((err,res)=>{
                ...
                expect(res.body.data).have.keys(['message','gifTitle','comment','createdOn'])
